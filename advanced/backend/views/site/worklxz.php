...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Liu Xingze | YongShou Palace Backend</title>
                                            ...
                                            <div class="col-sm order-2 order-sm-1">
                                                <div class="d-flex align-items-start mt-3 mt-sm-0">
                                                    <div class="flex-grow-1">
                                                        <div>
                                                            <h5 class="font-size-16 mb-1">刘兴泽</h5>
                                                            <p class="text-muted font-size-13">1911439</p>

                                                            <div class="d-flex flex-wrap align-items-start gap-2 gap-lg-3 text-muted font-size-13">
                                                                <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>Development</div>
                                                                <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>2860376164@qq.com</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl">
                                                                <div class="text-muted">
                                                                    <p class="mb-2">链接：https://pan.baidu.com/s/1E8EgOScYDKNv-nLbGNhWmg</p>
                                                                    <p class="mb-0">提取码：r0r2 </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="col-xl">
                                                                <div class="text-muted">
                                                                    <ul class="list-unstyled mb-0">
                                                                        ...
                                                                        <li class="py-1"><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>数据库视图的设计</li>
                                                                        <li class="py-1"><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>前端留言功能的开发</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
