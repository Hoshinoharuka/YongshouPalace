...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Yuan Zhenzhi | YongShou Palace Backend</title>
                                            ...
                                            <div class="col-sm order-2 order-sm-1">
                                                <div class="d-flex align-items-start mt-3 mt-sm-0">
                                                    <div class="flex-grow-1">
                                                        <div>
                                                            <h5 class="font-size-16 mb-1">袁贞芷</h5>
                                                            <p class="text-muted font-size-13">1911584</p>

                                                            <div class="d-flex flex-wrap align-items-start gap-2 gap-lg-3 text-muted font-size-13">
                                                                <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>Development</div>
                                                                <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>29192189@qq.com</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl">
                                                                <div class="text-muted">
                                                                    <p class="mb-2">链接：https://pan.baidu.com/s/1N5XDJUwxTC2ypWX9yHwtuw </p>
                                                                    <p class="mb-0">提取码：10sk</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="col-xl">
                                                                <div class="text-muted">
                                                                    <ul class="list-unstyled mb-0">
                                                                        <li class="py-1"><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>数据库表的设计与原始数据的导入</li>
                                                                        <li class="py-1"><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>后端设计与功能开发</li>
                                                                        <li class="py-1"><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>部分图片设计与制作</li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <blockquote class="blockquote font-size-14 mb-0">
                                            <p>The framework of Yii2 is really powerful, but it took a long time to learn the code and functionality of the framework.</p>
                                            <footer class="blockquote-footer mt-0 font-size-12">
                                            Some thoughts from <cite title="Source Title">Y</cite>
                                            </footer>
                                        </blockquote>
                                    </div>
                                </div>
