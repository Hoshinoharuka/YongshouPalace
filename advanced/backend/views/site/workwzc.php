...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Wang Zichun | YongShou Palace Backend</title>
                                            ...
                                            <div class="col-sm order-2 order-sm-1">
                                                <div class="d-flex align-items-start mt-3 mt-sm-0">
                                                    <div class="flex-grow-1">
                                                        <div>
                                                            <h5 class="font-size-16 mb-1">王子莼</h5>
                                                            <p class="text-muted font-size-13">1911575</p>

                                                            <div class="d-flex flex-wrap align-items-start gap-2 gap-lg-3 text-muted font-size-13">
                                                                <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>Development</div>
                                                                <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>1433816968@qq.com</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
