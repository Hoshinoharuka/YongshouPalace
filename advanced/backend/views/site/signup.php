...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Register | Yongshou Palace</title>
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">Already have an account ? <a href="<?php echo Url::to(['site/login']) ?>" class="text-primary fw-semibold"> Login </a> </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
